...
namespace Proyecto_Bugs_Extendido.Datos
{
    class ProyectoDao
    {
        ...
        private Proyecto ObjectMapping(DataRow row)
        {
            Proyecto oProyecto = new Proyecto
            {
                ...
                Responsable = new Usuario()
                {
                    ...
                    NombreUsuario = row["responsable"].ToString(),
                }
            };
        ...
        public bool Create(Proyecto oProyecto)
        {
            ...
            string consultaSQL = "INSERT INTO Proyectos (id_proyecto,id_producto,descripcion,version,alcance,id_responsable,borrado)" +
                                " VALUES (((select max(p.id_proyecto) from Proyectos p)+1)," +
                                oProyecto.OProducto.Id_producto +",'"+
        ...
        public bool Update(Proyecto oProyecto)
        {
            string consultaSQL ="UPDATE Proyectos" +
                                " SET id_producto = "+oProyecto.OProducto.Id_producto+","+
